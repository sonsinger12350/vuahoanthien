        ...
        <div class="col-lg-4 py-1">
          ...
          <div class="mt-4">
            <div class="footer-logo mb-3">
              <img src="<?php site_the_assets();?>images/bo-cong-thuong.png" />
            </div>
    ...
    <div class="row justify-content-center">
      <div class="col-12 brands-wrapper py-3">
        ...
        <a href="<?php echo $link; //the_field( 'link', $key );?>" title="<?php echo $item->name;?>">
          <img src="<?php echo wp_get_attachment_image_url( $image, 'full' );?>" alt="<?php echo $item->name;?>" />
        </a>
        <?php 
          //   if( $i == 9 ) {
      ...
      <p class="my-4 col-12 col-lg-8 text-center d-lg-block"> <!-- d-none  -->
        <small>
...
<div class="d-none fixed-bottom w-100 p-4" id="compareFooter">
  <div class="d-flex align-items-center justify-content-center">
    <p>Bạn đã chọn <span class="number">0</span> sản phẩm để so sánh (Tối đa 4 sản phẩm).</p>
