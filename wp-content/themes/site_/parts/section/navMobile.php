      ...
      <div class="row navbar-main-wrap">
        <div class="col-6 col-lg-3 col-xxl-3 d-flex mobile-pr-0 align-items-center">
          ...
          <a class="link-main-logo" href="<?php echo home_url();?>">
            <picture>
              <source media="(min-width: 640px)" srcset="<?php site_the_assets();?>images/logo/VHT-new-logo-mb.png">
              <source media="(max-width: 575.98px)" srcset="<?php site_the_assets();?>images/logo/VHT-new-logo-mb.png">
              <img src="<?php site_the_assets();?>images/logo/VHT-new-logo-mb.png" class="img-fluid w-80" title="Vua Hoàn Thiện">
            </picture>
          </a>
        ...
        <div class="col-6 col-lg-9 col-xxl-9 mobile-pl-0 d-flex align-items-center col-right-menu">
           <!-- justify-content-end -->
            ...
            <li>
              <div class="tracking-order-menu">
                <a class="rounded" href="<?php echo home_url('trang-thai-don-hang');?>">
                  ...
                  <img src="<?php site_the_assets();?>images/icons/shipping-car-vuahoanthien.png" class="img-fluid" title="Vie Home Depot">
                </a>
              </div>
            </li>
