...
?>
	<div class="yith_wcwl_wishlist_footer <?php echo (is_user_logged_in())?"isUSer":""; ?>">
		<div class="container">
			<?php if ( $count && $show_cb ) : ?>
				...
				<div class="yith_wcwl_wishlist_bulk_action">
					...
					<input class="btn btn-lg px-4 btn-primary rounded" type="submit" name="apply_bulk_actions" value="<?php esc_html_e( 'Apply', 'yith-woocommerce-wishlist' ); ?>"/>
				</div>
			<?php endif; ?>
			...
			<?php if ( $count && $show_update ) : ?>
				...
				<div class="yith_wcwl_wishlist_update d-none">
			...
			<?php if ( $count && ( $show_ask_estimate_button || $enable_add_all_to_cart ) ) : ?>
				<div class="yith_wcwl_footer_additional_action">
					...
					<?php if ( $count && $enable_add_all_to_cart ) : ?>
						...
						<input class="btn btn-lg px-5 py-0 btn-primary rounded" type="submit" name="add_all_to_cart" value="<?php esc_html_e( 'Add all to cart', 'yith-woocommerce-wishlist' ); ?>"/>
					<?php endif; ?>
				</div>
			<?php endif; ?>
		</div>
