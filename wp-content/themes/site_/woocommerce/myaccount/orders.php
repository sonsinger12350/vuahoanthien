...
<div class="input-group search-box mb-3">
  <input type="text" class="form-control search-input"
    ...
    aria-describedby="button-addon2" name="order_id" value="<?php echo site__get('order_id', '');?>">
...
<div class="tab-content" id="trackOrderContent">
  <div class="tab-pane fade show active" id="all-orders" role="tabpanel" aria-labelledby="all-orders-tab">
    ...
    ?>
    <div class="card card-body order border-top order-id-<?php echo $data['id'];?>" data-status="<?php echo $order->get_status();?>">
      ...
      <div class="order-footer pt-3">
        <h5 class="text-end"><span class="text-grey">Tổng tiền:</span> <?php echo site_wc_price($data['total']);?> <sup class="fs-12">đ</sup></h5>
      </div>
    </div>
    <?php 
        endforeach;
