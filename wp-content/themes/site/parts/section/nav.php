...
<nav class="static-top navbar-expand-lg navbar-main">
	<?php get_template_part('parts/section/highlight'); ?>
	<div class="nav-wrapper">
		<div class="container"> <!-- pt-2 -->
			<div class="row navbar-main-wrap">
				<div class="col-6 col-lg-3 col-xxl-3 d-flex mobile-pr-0 align-items-center">

					<button class="navbar-toggler btn-menu" id="btnMenu" type="button" data-bs-toggle="collapse" data-bs-target="#mainMenu" aria-controls="mainMenu" aria-expanded="false" aria-label="Toggle navigation">
					...
					<a class="link-main-logo" href="<?php echo home_url(); ?>">
						<picture>
							...
							<img src="<?php site_the_assets(); ?>images/logo/VHT-new-logo.svg" class="img-fluid w-80" title="Vua Hoàn Thiện" loading="lazy">
						</picture>
					</a>
				...
				<div class="col-6 col-lg-9 col-xxl-9 mobile-pl-0 d-flex align-items-center justify-content-end">
					<div class="search-box">
						<div class="search-btn-item show-on-mobile"><i class="bi bi-search"></i></div>
						<!-- <form class="input-group" action="<?php //echo $shop_page_url;
																?>#top">
					...
					<div class="nav-mb-right collapse px-sm-down-0" id="profileNav">
						<ul class="navbar-nav">
							<?php if ($user->ID > 0): ?>
								...
								<li class="nav-item">
									<a class="nav-link" href="<?php echo esc_url(wc_get_account_endpoint_url('wishlist')); ?>">
			  ...
			  <?php */ ?>
						...
						<div class="tracking-order-menu">
							<a class="rounded" href="<?php echo home_url('trang-thai-don-hang'); ?>">
								...
								<img src="<?php site_the_assets(); ?>images/icons/shipping-car-vuahoanthien.png" class="img-fluid" title="Vua Hoàn Thiện" loading="lazy">
							</a>
						</div>
					</div>
