...
switch ($loai_sp) {
  ...
  case "cong_tac_o_cam":   
    ...
    break; 
  case "o_cam_thong_minh":   
    $specs_sp = get_field("o_cam_thong_minh_specs");
    break;  
  ...
  case "pittong_nang_canh_tu":   
    ...
    break;    
  case "may_giat":   
    $specs_sp = get_field("may_giat_specs");
    break;
  case "dong_co_rem_thong_minh":   
    $specs_sp = get_field("dong_co_rem_thong_minh_specs");
    break;
  case "may_say":   
    $specs_sp = get_field("may_say_specs");
    break;
  case "camera_thong_minh":   
    $specs_sp = get_field("camera_thong_minh_specs");
    break;      
  case "noi_com_dien":   
    $specs_sp = get_field("noi_com_dien_specs");
    break;
  case "noi_ap_suat":   
    $specs_sp = get_field("noi_ap_suat_specs");
    break;
  case "may_huy_rac":   
    $specs_sp = get_field("may_huy_rac_specs");
    break;
  case "may_loc_khong_khi":   
    $specs_sp = get_field("may_loc_khong_khi_specs");
    break;
  case "may_hut_am":   
    $specs_sp = get_field("may_hut_am_specs");
    break;  
  case "may_loc_khong_khi_xe_hoi":   
    $specs_sp = get_field("may_loc_khong_khi_xe_hoi_specs");
    break;
  case "quat_tran":   
    $specs_sp = get_field("quat_tran_specs");
    break;
  case "noi_chien_khong_dau":   
    $specs_sp = get_field("noi_chien_khong_dau_specs");
    break;
  case "may_nuong_banh_my":   
    $specs_sp = get_field("may_nuong_banh_my_specs");
    break;
  case "may_xay_ca_phe":   
    $specs_sp = get_field("may_xay_ca_phe_specs");
    break;
  case "may_pha_ca_phe":   
    $specs_sp = get_field("may_pha_ca_phe_specs");
    break; 
  case "am_sieu_toc":   
    $specs_sp = get_field("am_sieu_toc_specs");
    break;
  case "may_ep":   
    $specs_sp = get_field("may_ep_specs");
    break;
  case "may_ep_cham":   
    $specs_sp = get_field("may_ep_cham_specs");
    break;
  case "may_vat_cam":   
    $specs_sp = get_field("may_vat_cam_specs");
    break;
  case "may_xay_cam_tay":   
    $specs_sp = get_field("may_xay_cam_tay_specs");
    break;
  case "may_giat_ket_hop_say":   
    $specs_sp = get_field("may_giat_ket_hop_say_specs");
    break; 
  case "may_xay_sinh_to":   
    $specs_sp = get_field("may_xay_sinh_to_specs");
    break;
  case "may_nuoc_nong_truc_tiep":   
    $specs_sp = get_field("may_nuoc_nong_truc_tiep_specs");
    break;
  case "may_nuoc_nong_gian_tiep":   
    $specs_sp = get_field("may_nuoc_nong_gian_tiep_specs");
    break;
  case "quat_dien":   
    $specs_sp = get_field("quat_dien_specs");
    break;   
  case "quat_sac_gap_gon":   
    $specs_sp = get_field("quat_sac_gap_gon_specs");
    break; 
  case "den_diet_khuan":   
    $specs_sp = get_field("den_diet_khuan_specs");
    break;
  case "den_led_de_ban":   
    $specs_sp = get_field("den_led_de_ban_specs");
    break;
  case "set_thiet_bi_thong_minh":   
    $specs_sp = get_field("set_thiet_bi_thong_minh_specs");
    break;
  case "may_tron_cam_tay":   
    $specs_sp = get_field("may_tron_cam_tay_specs");
    break;  
  case "tay_nam_tu":   
    $specs_sp = get_field("tay_nam_tu_specs");
    break;
  case "gach_bong_gio":   
    $specs_sp = get_field("gach_bong_gio_specs");
    break;
  case "thiet_bi_bao_chay":   
    $specs_sp = get_field("thiet_bi_bao_chay_specs");
    break;
  case "tay_nang_canh_tu":   
    $specs_sp = get_field("tay_nang_canh_tu_specs");
    break; 
  case "ngoi":   
    $specs_sp = get_field("ngoi_specs");
    break;
  case "may_loc_nuoc":   
    $specs_sp = get_field("may_loc_nuoc_specs");
    break;                   
  case "son_nuoc":   
    $specs_sp = get_field("son_nuoc_specs");
    break;  
  case "bot_tret":   
