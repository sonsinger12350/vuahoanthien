							...
							<tr>
								...
								<td class="fs-12 text-end">
									...
									if ($_product->get_price() > 0) {
										echo site_wc_price($sub_total = $_product->get_price() * $cart_item['quantity']) . '<sup class="unit-price-symbol">đ</sup>';
									} else {
										echo 'Liên hệ';
									}
									?>
	...
	<div class="pt-2">
		<?php if (count($cart_coupons) > 0 || count($cart_point_reward) > 0): ?>
			<div class="d-flex justify-content-between pb-2 border-bottom">
				<small>Tổng</small>
				<small><?php echo site_wc_price($cart_totals['subtotal']); ?><sup class="unit-price-symbol" style="font-size: 8px;">đ</sup></small>
			</div>
			<?php foreach ($cart_coupons as $code => $coupon) : ?>
		...
		<div class="d-flex justify-content-between py-2">
			...
			<div class="d-flex flex-column align-items-end">
				<span class="fs-4 fw-bold text-danger"><?php
														...
														?><sup class="unit-price-symbol" style="top: -5px;">đ</sup></span>
