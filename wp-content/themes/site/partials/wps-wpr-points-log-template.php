...
if ( isset( $user_id ) && null != $user_id && is_numeric( $user_id ) ) {
	...
	if ( isset( $point_log ) && is_array( $point_log ) && null != $point_log ) {
		?>
		<h2 class="mb-4 section-header border-0 mg-top-0"><span><?php esc_html_e( ' Point Log Table', 'points-and-rewards-for-woocommerce' ); ?></span></h2>
		
		<?php if($show_log == true): ?>
	...
	<?php endif; ?>
		...
		echo '<h4>' . esc_html__( 'No Points Generated Yet.', 'points-and-rewards-for-woocommerce' ) . '<h4>';
	}
}
?>
