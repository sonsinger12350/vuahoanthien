...
class Filters {
	...
	public function __construct() {
		...
		add_filter( 'woocommerce_product_data_store_cpt_get_products_query', [ $this, 'woocommerce_product_data_store_cpt_get_products_query' ], 10, 2 );
	}
	...
	public function woocommerce_product_data_store_cpt_get_products_query( $wp_query_args, $query_vars ) {
		...
		foreach ( $taxonomies as $taxonomy => $terms ) {
			...
			$field = in_array( $taxonomy, [ 'product_cat', 'product_tag' ] ) ? 'term_id' : 'slug';
