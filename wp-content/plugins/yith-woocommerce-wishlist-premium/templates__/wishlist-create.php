...
<div class="yith-wcwl-wishlist-new">
	 ...
	 */
	?>
	<input class="w-100 btn btn-outline-primary px-1 border-2 rounded fw-bold fs-10 create-wishlist-button" type="submit" name="create_wishlist" value="<?php echo esc_attr( apply_filters( 'yith_wcwl_create_wishlist_button_label', __( 'Create wishlist', 'yith-woocommerce-wishlist' ) ) ); ?>"/>
