					...
					<div class="item-details">
						...
						<?php if ( $show_rename_wishlist ) : ?>
							<div class="hidden-title-form">
								<input type="text" class="" value="<?php echo esc_attr( $wishlist->get_formatted_name() ); ?>" name="wishlist_options[<?php echo esc_attr( $wishlist->get_id() ); ?>][wishlist_name]"/>
						...
						if ( $wishlist->has_items() ) :
							...
							<div class="placeholder-item empty-box">
								<p>
									<?php
									/**
									 * APPLY_FILTERS: yith_wcwl_modern_wishlist_empty_message
									 *
									 * Filter the message when there are no products in the wishlist in the modern layout.
									 *
									 * @param string $message Message
									 *
									 * @return string
									 */
									echo wp_kses_post( apply_filters( 'yith_wcwl_modern_wishlist_empty_message', __( 'This wishlist is empty.<br/>Add some item soon!', 'yith-woocommerce-wishlist' ) ) );
									?>
								</p>
							</div>
							<?php
