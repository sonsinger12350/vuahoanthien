...
if ( ! class_exists( 'YITH_WCWL_Frontend_Premium' ) ) {
	...
	class YITH_WCWL_Frontend_Premium extends YITH_WCWL_Frontend_Extended {
		...
		public function __construct() {
			...
			add_action( 'yith_wcwl_wishlist_after_wishlist_content', array( $this, 'add_back_to_all_wishlists_link' ), 20, 1 );
			add_action( 'yith_wcwl_before_wishlist_title', array( $this, 'add_wishlist_links' ) );
