...
if ( ! class_exists( 'YITH_WCWL_Estimate_Email' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class YITH_WCWL_Estimate_Email extends YITH_WCWL_Mail {
		...
		public function trigger( $wishlist_id, $additional_notes, $reply_email, $additional_data ) {
			...
			/**
			 * APPLY_FILTERS: yith_wcwl_estimate_additional_data
			 *
			 * Filter the additional data sent in the 'Ask for an estimate' email.
			 *
			 * @param array                    $additional_data Additional data
			 * @param array                    $post_data       Post data
			 * @param YITH_WCWL_Estimate_Email $email           Email object
			 *
			 * @return array
			 */
			$this->additional_data = apply_filters( 'yith_wcwl_estimate_additional_data', $additional_data, $_POST, $this ); // phpcs:ignore WordPress.Security.NonceVerification
