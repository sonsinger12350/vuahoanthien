...
if ( ! class_exists( 'YITH_WCWL_Back_In_Stock_Email' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class YITH_WCWL_Back_In_Stock_Email extends YITH_WCWL_Mail {
		...
		public function get_custom_content_html() {
			...
			$replace = array(
				 ...
				 * @param YITH_WCWL_Back_In_Stock_Email $email Email object
				 *
				 * @return string
				 */
		...
		public function init_form_fields() {
			...
			$this->form_fields = array(
				'enabled'             => array(
					...
					'type'                 => 'yith_wcwl_field',
					'yith_wcwl_field_type' => 'onoff',
