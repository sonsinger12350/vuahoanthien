...
Faview - Virtual Reviews for WooCommerce generates virtual reviews and displays canned reviews to boost your customer engagement.
...
>[Try the Demo](http://new2new.com/?item=faview "Demo Virtual Reviews for WooCommerce") | [Documents](http://docs.villatheme.com/?item=faview "Documents" ) |[Pro Version](https://1.envato.market/jW36P0 "Pro Version") | [Facebook group](https://www.facebook.com/groups/villatheme "VillaTheme")
...
- **Schedule**: Schedule time to automatically add virtual reviews

- **Content rules** Create reviews with content appropriate to different products/product groups.
...
- [Getting Started](http://docs.villatheme.com/woo-virtual-reviews/)

### Plugin Links

- [Project Page](http://villatheme.com)
- [Documentation](http://docs.villatheme.com/woo-virtual-reviews/)
...
== Screenshots ==
1. General settings
2. Auto generate reviews
3. Add reviews manual
4. Show canned
