					...
					<div class="item-details">
						...
						<div class="wishlist-item-row">	
							...
							<?php if ( $show_date_of_creation ) : ?>
								<div class="wishlist-dateadded">
									<div class="label"><?php esc_html_e( 'Created on:', 'yith-woocommerce-wishlist' ); ?></div>
									<div class="value"><?php echo esc_html( $wishlist->get_date_added_formatted() ); ?></div>
								</div>
							<?php endif; ?>
						</div>
					</div>
