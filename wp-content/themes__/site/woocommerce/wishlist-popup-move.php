...
<div id="move_to_another_wishlist">
	<form action="<?php echo esc_attr( $move_to_another_wishlist_url ); ?>" method="post" class="wishlist-move-to-another-wishlist-popup">
		...
		<div class="yith-wcwl-popup-footer">
			<button class="w-100 btn btn-outline-primary px-1 border-2 rounded fw-bold fs-10 move-to-another-wishlist-button move-to-another-wishlist-button-popup wishlist-submit button alt">
				<?php
				/**
