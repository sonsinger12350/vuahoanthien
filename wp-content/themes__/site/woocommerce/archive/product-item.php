...
$saleoff_price = get_post_meta( $product_id, 'sale_off', true );
...
<div class="card h-100 product-item">
  ...
  <div class="position-absolute top-0 end-0 btn-favorite">
    ...
    <?php if( $virtual_count>0 ):?>
      <sup class="like-count d-none"><?php echo $virtual_count;//wp_kses_post( yith_wcwl_get_count_text( $product_id ) );//$user_count;//$like;?></sup>
    <?php endif;?>
      ...
      <div class="d-flex flex-row flex-wrap align-items-end justify-content-between">
        <div class="product-price-left">
          <?php if ($product_price_sale>0): ?>
            <p><small><del><?php echo $product_price; ?> <sup class="fs-12 text">đ</sup></del></small></p>
            <p><b class="me-1 text-danger"><?php echo $product_price_sale; ?><sup class="text-danger fs-12 text">đ</sup></b></p>
          <?php else: ?>
            <p><small>&nbsp;</small></p>
            <p><b class="me-1 text-danger"><?php echo $product_price; ?><sup class="text-danger fs-12 text">đ</sup></b></p>
          <?php endif ?>
