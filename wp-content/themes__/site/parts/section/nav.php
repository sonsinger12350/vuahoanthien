        ...
        <div class="col-6 col-lg-3 col-xxl-3 d-flex mobile-pr-0 align-items-center">
          ...
          <a class="link-main-logo" href="<?php echo home_url();?>">
            <picture>
              ...
              <img src="<?php site_the_assets();?>images/logo/VHT-new-logo.svg" class="img-fluid w-80" title="Vua Hoàn Thiện">
            </picture>
          </a>
          ...
          <ul class="nav nav-right">
            <li class="nav-item">
              <span class="nav-link d-flex align-items-center">
                <a class="d-lg-none btn-menu" data-bs-toggle="collapse" data-bs-target="#profileNav">
          ...
          <div class="navbar-collapse px-sm-down-0 collapse" id="mainMenu">
            ...
            <div class="tracking-order-menu">
              <a class="rounded" href="<?php echo home_url('trang-thai-don-hang');?>">
                ...
                <img src="<?php site_the_assets();?>images/icons/shipping-car-vuahoanthien.png" class="img-fluid" title="Vua Hoàn Thiện">
              </a>
            </div>
          </div>
