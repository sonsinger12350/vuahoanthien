    ...
    .forEach(function (form) {
      ...
      $('input[required], select[required], textarea[required]').on('invalid', function() {
        if (this.validity.valueMissing) {
          ...
          this.setCustomValidity('Cấu trúc chưa đúng, vui lòng kiểm tra lại')
