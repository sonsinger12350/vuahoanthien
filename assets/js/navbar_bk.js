...
$(document).ready(function() {
	...
	if($(window).width() > 992) {
	  ...
	  // $('.btn-menu-mainMenu').on('click', function(e) {
  
	  //   var b = $(this).toggleClass('collapsed'), t = b.attr('aria-expanded');
  
  
  
	  //   b.attr('aria-expanded', t == 'true' ? 'false' : 'true' );
	  ...
	  // $showMenu.on('shown.bs.collapse', function() {
