(function ($) {
    ...
    $.fn.jbvalidator = function (options) {
        ...
        let errorMessages = {
            maxValue: "Giá trị phải nhỏ hơn hay bằng %s.",
            minValue: "Giá trị phải lớn hơn hay bằng %s.",
            // maxLength: "Please lengthen this text to %s characters or less (you are currently using %s characters).",
            maxLength: "Số điện thoại phải nhỏ hơn %s số.",
            minLength: "Số điện thoại phải lớn hơn %s số.",
            minSelectOption: "Hãy chọn ít nhất %s lựa chọn.",
            maxSelectOption: "Hãy chọn nhiều nhất %s lựa chọn.",
            groupCheckBox: "Hãy chọn ít nhất %s lựa chọn.",
            // equal: "This field does not match with %s field.",
            equal: "Thông tin chưa trùng khớp",
            fileMinSize: "Tập tin không được nhỏ hơn %s bytes.",
            fileMaxSize: "Tập tin không được lớn hơn %s bytes.",
            number: "Hãy nhập vào một số.",
            HTML5: {
                valueMissing: {
                    INPUT: {
                        default: "Hãy nhập thông tin.",
                        checkbox: "Hãy chọn thông tin.",
                        radio: "Chọn một trong những lựa chọn trên.",
                        file: "Chọn tập tin."
                    },
                    SELECT: "Chọn lựa chọn trong danh sách trên.",
                    TEXTAREA: "Hãy nhập nội dung vào."
                },
                typeMismatch: {
                    email: "Hãy nhập vào một địa chỉ email.",
                    url: "Hãy nhập vào một đường dẫn."
                },
                rangeUnderflow: {
                    date: "Giá trị phải từ %s hay trễ hơn.",
                    month: "Giá trị phải từ %s hay trễ hơn.",
                    week: "Giá trị phải từ %s hay trễ hơn.",
                    time: "Giá trị phải từ %s hay trễ hơn.",
                    datetimeLocale: "Giá trị phải từ %s hay trễ hơn.",
                    number: "Giá trị phải lớn hơn hay bằng %s.",
                    range: "Giá trị phải lớn hơn hay bằng %s."
                },
                rangeOverflow: {
                    date: "Giá trị phải từ %s hay sớm hơn.",
                    month: "Giá trị phải từ %s hay sớm hơn.",
                    week: "Giá trị phải từ %s hay sớm hơn.",
                    time: "Giá trị phải từ %s hay sớm hơn.",
                    datetimeLocale: "Giá trị phải từ %s hay sớm hơn.",
                    number: "Giá trị phải nhỏ hơn hay bằng %s.",
                    range: "Giá trị phải nhỏ hơn hay bằng %s."
                },
                stepMismatch: {
                ...
                tooLong: "Số điện thoại phải nhỏ hơn %s số.",
                tooShort: "Số điện thoại phải lớn hơn %s số.",
                patternMismatch: "Hãy đồng bộ nội dung với %s",
                badInput: {
                    number: "Hãy nhập vào một số."
                }
            }
